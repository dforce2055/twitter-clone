<template>
  ...
  <button
      ...
      type="button"
      :class="classes"
      class="justify-center rounded-md border border-transparent bg-slate-300 text-white dark:bg-dim-700 shadow-sm cursor-not-allowed  font-medium text-sm px-x py-2"
    >
...
const classes = computed(() => `${sizeClasses.value} ${styleClasses.value}`)
