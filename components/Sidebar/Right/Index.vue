    ...
    <div class="relative m-2">
      ...
      >
        <div class="w-6 h-6">
          <MagnifyingGlassIcon
            @click="handleSearch"
            class="w-6 h-6 text-gray-100 dark:text-sky-600 cursor-pointer"
          />
        </div>
      </div>
      <input
        v-model="search"
        class="flex items-center w-full pl-12 text-sm font-normal 
        text-black bg-gray-200 border border-gray-200 rounded-full shadow 
        dark:text-gray-100 dark:bg-dim-400 dark:border-dim-400 focus:bg-gray-100 
        dark:focus:bg-dim-900 dark:focus:text-gray-100 focus:outline-none focus:border focus:border-blue-200 h-9"
...
const whatsHappeningItems: any = ref([
  {
    title: "SpaceX",
    count: "18.8k Tweets",
  },
...
const handleToggleDarkMode = () => {
  const darkMode = appStore.$state.darkMode as boolean;
